...
namespace Proyecto_TB2
{
    public partial class Procedimientos : Form
    {
        ...
        private void treeView1_MouseDoubleClick(object sender, MouseEventArgs e)
        {
            ...
            else if (treeView1.SelectedNode.Parent.ToString() == "Procedimientos")
            {
